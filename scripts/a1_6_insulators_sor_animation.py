"""Animation of SOR convergence with an insulating object (Assignment 1.6.L).
...
# Insulating object (same as a1_6_insulators_sor.py)
ins_coords = construct_rectangle(21, 38, 34, 43)
is_insulator = get_insulator_grid(N, ins_coords)
is_sink = get_sink_grid(N, None)
...
ax.set_aspect("equal")
fig.suptitle(f"SOR with insulating object ($\\omega = {omega:.1f}$)")
...
out_path = out_dir / "a1_6_insulators_sor.gif"
